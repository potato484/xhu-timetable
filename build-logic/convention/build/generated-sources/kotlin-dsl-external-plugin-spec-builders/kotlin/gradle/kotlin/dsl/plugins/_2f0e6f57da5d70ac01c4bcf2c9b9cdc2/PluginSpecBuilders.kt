...
package gradle.kotlin.dsl.plugins._2f0e6f57da5d70ac01c4bcf2c9b9cdc2
...
/**
 * The `app` plugin group.
 */
@org.gradle.api.Generated
internal
class `AppPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `app`.
 */
internal
val `PluginDependenciesSpec`.`app`: `AppPluginGroup`
    get() = `AppPluginGroup`(this)


/**
 * The `app.cash` plugin group.
 */
@org.gradle.api.Generated
internal
class `AppCashPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `app.cash`.
 */
internal
val `AppPluginGroup`.`cash`: `AppCashPluginGroup`
    get() = `AppCashPluginGroup`(plugins)


/**
 * The `app.cash.sqldelight` plugin implemented by [app.cash.sqldelight.gradle.SqlDelightPlugin].
 */
internal
val `AppCashPluginGroup`.`sqldelight`: PluginDependencySpec
    get() = plugins.id("app.cash.sqldelight")
