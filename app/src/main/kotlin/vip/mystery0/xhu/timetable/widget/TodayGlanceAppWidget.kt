...
import vip.mystery0.xhu.timetable.widget.state.TodayGlanceStateDefinition
            ...
            Column {
                Row(
                    ...
                    Text(
                        ...
                        text = "查看更多 >",
                        style = TextStyle(color = ColorProvider(colors.onSurface)),
                    )
                }
        ...
        Box(modifier = GlanceModifier.padding(vertical = 4.dp)) {
            Row(
                modifier = GlanceModifier
                    ...
                    .background(todayCourseGlance.color.copy(alpha = 0.5f))
                    .cornerRadius(4.dp),
            ) {
